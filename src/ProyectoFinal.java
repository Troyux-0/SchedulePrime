...
public class ProyectoFinal
{
    ...
    public static void horario()
    {
        ...
        int actividadesActuales = contadorActividadesHorario[usuarioIndice];
        boolean continuar = true;
        ...
        while (continuar)
        {
            ...
            switch (opcion)
            {
                case 1:
                    if (actividadesActuales < maxActividades)
                    {
                        ...
                        do
                        {
                            ...
                            {
                                diaOk = true;
                                dias[usuarioIndice][actividadesActuales] = diaIngresado;
                            }
                            else
                            {
                        ...
                        hora[usuarioIndice][0][actividadesActuales] = horaIngresada;
                        ...
                        hora[usuarioIndice][1][actividadesActuales] = minutoIngresado;

                        System.out.print("Actividad: ");
                        actividadesHorario[usuarioIndice][actividadesActuales] = scanner.nextLine();
                        System.out.print("Notas adicionales: ");
                        notasHorario[usuarioIndice][actividadesActuales] = scanner.nextLine();

                        contadorActividadesHorario[usuarioIndice]++;
                        actividadesActuales = contadorActividadesHorario[usuarioIndice];
                ...
                case 2:
                    ...
                    switch (subOpcion)
                    {
                        case 1:
                            ...
                            if (actividadesActuales > 0)
                            {
                                ...
                                for (int i = 0; i < actividadesActuales; i++)
                                {
                                    ...
                                    System.out.println("Día -" + dias[usuarioIndice][i]);
                                    System.out.println(String.format("Hora - %02d:%02d", hora[usuarioIndice][0][i], hora[usuarioIndice][1][i]));
                        ...
                        case 2:
                            ...
                            if (actividadesActuales > 0)
                            {
                                ...
                                for (int i = 0; i < actividadesActuales; i++)
                                {
                                    ...
                                    System.out.println(dias[usuarioIndice][i]);
                                    System.out.println(String.format("Hora - %02d:%02d", hora[usuarioIndice][0][i], hora[usuarioIndice][1][i]));
                                    System.out.println(actividadesHorario[usuarioIndice][i]);
                                    System.out.println("--------------");
                                }
                                ...
                                {
                                    System.out.println("Actividad seleccionada: " + actividadesHorario[usuarioIndice][indice - 1]);
                                    System.out.println("Notas actuales: " + notasHorario[usuarioIndice][indice - 1]);
                                    System.out.print("Ingresa las nuevas notas: ");
                                    notasHorario[usuarioIndice][indice - 1] = scanner.nextLine();
                        ...
                        case 3:
                            ...
                            {
                                OrdenarBurbujaHorarioProximidad(usuarioIndice, actividadesActuales);
                                System.out.println("Presiona la tecla Enter para continuar.");
                                scanner.nextLine();
                            }
                            break;
                ...
                case 3:
                    ...
                    if (tempOpcionEliminar != -1)
                    {
                        opcionEliminar = tempOpcionEliminar;
                    }
                    ...
                    switch (opcionEliminar)
                    {
                        case 1:
                            if (actividadesActuales > 0)
                            {
                                ...
                                for (int i = 0; i < actividadesActuales; i++)
                                {
                                    System.out.println("Indice " + (i + 1) + ": " + dias[usuarioIndice][i] + " " +
                                            String.format("%02d:%02d", hora[usuarioIndice][0][i], hora[usuarioIndice][1][i]) + " " +
                                            actividadesHorario[usuarioIndice][i]);
                                }
                                ...
                                if (indice >= 1 && indice <= actividadesActuales)
                                {
                                    ...
                                    System.out.println("Día: " + dias[usuarioIndice][indice - 1]);
                                    System.out.println("Hora: " + String.format("%02d:%02d", hora[usuarioIndice][0][indice - 1], hora[usuarioIndice][1][indice - 1]));
                                    System.out.println("Actividad: " + actividadesHorario[usuarioIndice][indice - 1]);
                                    System.out.println("Notas: " + notasHorario[usuarioIndice][indice - 1]);
                                    ...
                                    if (confirmacion.equals("s") || confirmacion.equals("si"))
                                    {
                                        ...
                                        {
                                            dias[usuarioIndice][i] = dias[usuarioIndice][i + 1];
                                            hora[usuarioIndice][0][i] = hora[usuarioIndice][0][i + 1];
                                            hora[usuarioIndice][1][i] = hora[usuarioIndice][1][i + 1];
                                            actividadesHorario[usuarioIndice][i] = actividadesHorario[usuarioIndice][i + 1];
                                            notasHorario[usuarioIndice][i] = notasHorario[usuarioIndice][i + 1];
                                        }
                                        contadorActividadesHorario[usuarioIndice]--;
                                        actividadesActuales = contadorActividadesHorario[usuarioIndice];
                        ...
                        case 2:
                            if (actividadesActuales > 0)
                            {
                                ...
                                for (int i = 0; i < actividadesActuales; i++)
                                {
                                    System.out.println((i + 1) + ". " + dias[usuarioIndice][i] + " " +
                                            String.format("%02d:%02d", hora[usuarioIndice][0][i], hora[usuarioIndice][1][i]) + " - " +
                                            actividadesHorario[usuarioIndice][i]);
                                }
                                ...
                                if (confirmacion.equalsIgnoreCase("ELIMINAR"))
                                {
                                    ...
                                    if (confirmacion2.equals("s") || confirmacion2.equals("si"))
                                    {
                                        ...
                                        contadorActividadesHorario[usuarioIndice] = 0;
    ...
    public static void mostrarHorarioTabla(int usuarioIndice, int actividadesActuales)
    {
        ...
        System.out.println("Fecha actual: " + String.format("%02d/%02d/%04d", fechaActual.getDayOfMonth(), fechaActual.getMonthValue(), fechaActual.getYear()));
        ...
        while (continuar)
        {
            ...
            switch (opcion)
            {
                ...
                case 2:
                    ...
                    if (tempOpcionNotas != -1)
                    {
                        opcionNotas = tempOpcionNotas;
                    }
                    ...
                    switch (opcionEliminarCal)
                    {
                        ...
                        case 2:
                            if (actividadesActuales > 0)
                            {
                                ...
                                for (int i = 0; i < actividadesActuales; i++)
                                {
                                    System.out.println((i + 1) + ". " + String.format("%02d/%02d/%04d", fechas[usuarioIndice][0][i], fechas[usuarioIndice][1][i], fechas[usuarioIndice][2][i]) + " - " + actividadesCalendario[usuarioIndice][i]);
                                }
    ...
    public static void OrdenarBurbujaCalendarioPorProximidad(int usuarioIndice, int actividadesActuales)
    {
        ...
        for (int i = 0; i < actividadesActuales; i++)
        {
            LocalDate fechaActividad = LocalDate.of(fechas[usuarioIndice][2][i], fechas[usuarioIndice][1][i], fechas[usuarioIndice][0][i]);
            ...
            System.out.println(String.format("Fecha: %02d / %02d / %d", fechas[usuarioIndice][0][i], fechas[usuarioIndice][1][i], fechas[usuarioIndice][2][i]));
